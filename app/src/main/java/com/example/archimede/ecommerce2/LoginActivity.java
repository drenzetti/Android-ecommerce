...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences = getSharedPreferences("UserAuth", MODE_PRIVATE);
        String auth = preferences.getString("Identified", null);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, User> {
        ...
        protected User doInBackground(Void... params) {
            ...
            UserRequest userRequest = new UserRequest(mEmail, mPassword);

            Call<User> loginCall = service.login(userRequest);

            try {
                Response<User> userResponse = loginCall.execute();
...
//            Call<List<Product>> listCall = service.listProduct();
//
//            try {
//                Response<List<Product>> productList = listCall.execute();
//                List<Product> i = productList.body();
//            } catch (IOException e) {
//                e.printStackTrace();
//            }
//
        ...
        protected void onPostExecute(final User success) {
            ...
            if (success != null) {
                ...
                editor.putString("Identified","OK");
                editor.apply();
